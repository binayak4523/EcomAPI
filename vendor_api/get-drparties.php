...
$sql = "
    SELECT AccID as ID, userid as customer_id, AccName as Party, Address1 as Address, Phone, TIN as Email, 
           StateCode, 0 as Duedays, 0 as Discount, 0 as CrLimit, GroupID as gid
    FROM ledgermaster
    WHERE Groupname = 'Sundry Debtor'
";
...
$countSql = "
    ...
    FROM ledgermaster
    WHERE Groupname = 'Sundry Creditor'
";
