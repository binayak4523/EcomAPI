...
// Add this block right after the opening tag
require_once __DIR__ . '/pg/init.php';  // path to the SDK setup
require_once __DIR__ . '/pg/vendor/autoload.php';
...
// 5. Basic validation
if (
    !isset($data["user_id"], $data["total_price"], $data["items"], $data["billingad_id"], $data["shippingad_id"], $data["payment_method"])
...
// 8. Check if payment method is online
